...
#
#     PHX_SERVER=true bin/tallyho start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :tallyho, TallyHoWeb.Endpoint, server: true
end
  ...
  config :tallyho, TallyHoWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/tallyho_web/router\.ex$",
        ~r"lib/tallyho_web/(controllers|live|components)/.*\.(ex|heex)$"
      ]
    ]
end
